  ...
  return (
    ...
    >
        ...
        <div className="text-sm min-h-[59px] py-2 flex gap-1">
          ...
          <div className="flex flex-col">
            <div className="flex gap-1 items-center">
              <div className="text-[#36394A] font-[Inter] text-base not-italic font-medium leading-6">
                {product.seller.name}
              </div>
              <div
              ...
              >
                <div className="flex w-[19px] h-[18px] flex-col justify-center text-center font-[Inter] text-xs not-italic font-semibold leading-[18px]">
            ...
            <div className="self-stretch text-[#6E7076] font-[Inter] text-xs not-italic font-normal leading-[18px]">
      ...
      <td className="align-middle text-right">
        <div className="min-h-[59px] py-2 text-[#36394A] font-[Inter] text-base not-italic font-normal leading-6">
          {product.amount}
        </div>
      </td>
      ...
      <td className="align-middle text-right">
        <div className=" min-h-[59px] py-2 flex flex-col gap-1">
          <div className=" text-[#36394A] text-right font-[Inter] text-base not-italic font-semibold leading-6">
            {product.price} ₽
          </div>
          {product.withIcons && (
