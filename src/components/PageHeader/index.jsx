        ...
        {categories.map((category) => {
          ...
          return (
            <button
              ...
              className={`font-[Inter] flex h-8 px-3 py-1 justify-center items-center gap-1.5 rounded-md transition-colors duration-150 hover:bg-[#DEE6FF] active:bg-[#BECCFE] active:text-white
                ${
                  isSelected
